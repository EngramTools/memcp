...
- **Plans:** 9 plans
  - [x] 25-00-PLAN.md — Wave 0: salience primitives (apply_stability_boost, revert_boost, is_source_of_any_derived) + migration 029 salience_audit_log + 11 RED test scaffolds + jsonschema/wiremock deps (SUMMARY: 25-00-SUMMARY.md, commits c3c9cea + 83f841b)
  - [x] 25-01-PLAN.md — ReasoningProvider trait + unified types + credentials + ReasoningConfig/ProfileConfig with seed dreaming+retrieval profiles (SUMMARY: 25-01-SUMMARY.md, commits b42758d + f09c44f)
